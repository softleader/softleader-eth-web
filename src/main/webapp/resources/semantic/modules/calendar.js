        ...
        module = {
          ...
          create: {
            calendar: function () {
              ...
              var columnsString = columns === 7 ? 'seven' : columns === 4 ? 'four' : 'two';
              var rows = isDay || isHour ? 6 : 1;
                ...
                for (c = 0; c < columns; c++, i++) {
                  var cellDate = isYear ? new Date(i, month, 1, hour, minute) :
                    isMonth ? new Date(year, i, 1, hour, minute) : isDay ? new Date(year, month, i, hour, minute) :
                      isHour ? new Date(year, month, day, i) : new Date(year, month, day, hour, i * 30);
          ...
          helper: {
            ...
            dateDiff: function (date1, date2, mode) {
              ...
              //only care about a minute accuracy of 30
              date1 = new Date(
                isTimeOnly ? 2000 : date1.getFullYear(),
                isTimeOnly ? 0 : isYear ? 0 : date1.getMonth(),
                isTimeOnly ? 1 : isYearOrMonth ? 1 : date1.getDate(),
                !isHourOrMinute ? 0 : date1.getHours(),
                !isMinute ? 0 : Math.floor(date1.getMinutes() / 30));
              date2 = new Date(
                isTimeOnly ? 2000 : date2.getFullYear(),
                isTimeOnly ? 0 : isYear ? 0 : date2.getMonth(),
                isTimeOnly ? 1 : isYearOrMonth ? 1 : date2.getDate(),
                !isHourOrMinute ? 0 : date2.getHours(),
                !isMinute ? 0 : Math.floor(date2.getMinutes() / 30));
